...
import type { PromotionPieceName } from '../core/models/history'
import { PromotionMove } from '../core/models/history'
import type { Colors } from '../core/models/pieces'
import { Piece } from '../core/models/pieces'
import {
  AlertDialog,
  AlertDialogContent,
  AlertDialogHeader,
  ...
  return (
    ...
    >
      <Card className="shadow-lg">
        <CardContent>
          <img src={Piece.getAssetUrl(color, pieceName)} />
        </CardContent>
      </Card>
    </button>
  )
